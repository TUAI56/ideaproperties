...
public class ExcelToCSV {
     ...
     * @param newFilePath
     */
    public void excelToCsv(String oldFilePath,String newFilePath){
        String buffer = "";
        Workbook wb =null;
        Sheet sheet = null;
        Row row = null;
    ...
    public void excelToCsv(String filename,InputStream is,String filePathAndName){
    ...
    public static void main(String[] args) throws Exception {
        ...
        excelToCSV.excelToCsv("C:\\Users\\000\\Desktop\\标签工作空间\\text1.xls",
                        "C:\\Users\\000\\Desktop\\标签工作空间\\text1.csv");
    }
}
