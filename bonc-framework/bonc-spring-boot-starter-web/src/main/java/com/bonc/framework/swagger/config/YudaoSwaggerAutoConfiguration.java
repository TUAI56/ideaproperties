package com.bonc.framework.swagger.config;

import com.bonc.framework.swagger.core.SpringFoxHandlerProviderBeanPostProcessor;
...
//                .apis(basePackage("com.bonc.module.system")) // 可用于 swagger 无法展示时使用
